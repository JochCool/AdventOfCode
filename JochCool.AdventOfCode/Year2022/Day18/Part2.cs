...
public static class Part2
{
	...
	public static string? Solve(TextReader inputReader)
	{
		...
		{
			int i = 0;
			int x = StringUtil.ParseInvariantAt<int>(line, ref i, ',') + 1;
			i++;
			int y = StringUtil.ParseInvariantAt<int>(line, ref i, ',') + 1;
			i++;
			int z = StringUtil.ParseInvariantAt<int>(line, ref i, ',') + 1;
